...
const AccessForm = () => {
  ...
  return (
    ...
    <p className='mt-2 mb-4 text-[#2F4F4F] '>2. Selecciona para qué tipo de discapacidad es accesible tu establecimiento haciendo clic en los botones de abajo. Luego, especifica qué adaptaciones has implementado en tu diseño accesible.</p>
