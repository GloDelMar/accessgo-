...
import ModalACC from '../atoms/modalAccessibilidadInfo';
...
const ImagenSubiryBorrarBase = ({ userId }) => {
  ...
  const openModalACC = () => setIsModalACCOpen(true);
  const closeModalACC = () => setIsModalACCOpen(false);
  ...
  return (
    <div className='flex flex-col justify-center items-center w-full max-w-[1022px] mx-auto'>
      <p className='text-[#2F4F4F] text-md mb-10'>Aqui puedes subir tus imagenes de {""}<span
        ...
        {/* Modal */}
      <ModalACC isOpen={isModalACCOpen} onClose={closeModalACC}>
