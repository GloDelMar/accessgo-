...
const View23 = () => {
  ...
  const toggleDay = (day) =>
    ...
    const datosRedesSociales = async () => {
      try {
        const response = await fetch('URL_DEL_SERVIDOR', {
          ...
          body: JSON.stringify(redesSociales) // Convierte el objeto en una cadena JSON
        });

        const data = await response.json(); // Puedes manejar la respuesta del servidor
