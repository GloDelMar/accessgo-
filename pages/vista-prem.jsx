  ...
  return (
    <div className='flex flex-col justify-center max-w-screen-sm  h-full md:p-4 lg:p-8'>
      <div className='w-full mt-4 flex flex-col justify-center items-center'>
        ...
        <img
  className='w-auto h-[300px] md:w-auto md:h-[250px] lg:w-auto lg:h-[250px] mt-8 object-contain'
...
/>
        ...
        <div className='flex items-center gap-5 mt-3'>
          <div>
            <a href=''>
              <img src='/facebook_logo.svg' alt='facebook' width={30} />
            </a>
          </div>
          <div>
            <a href=''>
              <img src='/x-logo.svg' alt='instagram' width={50} />
            </a>
          </div>
          <div>
            <a href=''>
              <img src='/instagram-logo.svg' alt='instagram' width={30} />
            </a>
          </div>
          <div>
            <a href=''>
              <img src='/tiktok-icon.svg' alt='tiktok' width={30} />
            </a>
          </div>
        </div>
      </div>
