...
const View8 = () => {
  ...
  return (
      ...
      <div className='flex flex-col items-center lg:flex-row lg:justify-center lg:items-start lg:space-x-8 px-4 mt-10'>
        ...
        <div className='flex flex-col  space-y-4 py-4 items-center lg:space-y-6 ml-18 '>
