        ...
        <div className="flex flex-col h-screen my-[40px] items-center bg-white w-[300px] md:w-[600px] p-2">
          ...
          <div className="w-[250px] md:w-[350px] mt-4">
            ...
            <div className="mb-2">
              ...
              <a onClick={() => handleUserType('usuario', '/4/registroUsuario')} className="flex items-center rounded-full justify-between bg-[#F5F0E5] hover:bg-[#E0D7C6] px-4 py-2 cursor-pointer">
